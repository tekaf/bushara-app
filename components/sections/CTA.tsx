...
export default function CTA() {
  return (
    <section className="relative overflow-hidden px-4 py-8 sm:py-14 lg:py-24">
      ...
      <div className="container relative mx-auto">
        ...
        >
          <h2 className="mb-6 text-[24px] font-bold leading-[1.25] text-[#1F2433] sm:text-[36px] md:text-[48px]">
            ابدأ الآن وأنشئ دعوتك
          </h2>
          <p className="mx-auto mb-8 max-w-2xl text-[14px] leading-6 text-[#7B8194] sm:text-[18px]">
